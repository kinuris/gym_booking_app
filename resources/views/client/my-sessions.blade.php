...
<body class="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen">
    ...
    <div class="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div class="bg-gray-800/80 rounded-xl p-8 text-center shadow-lg">
            ...
            <a href="{{ route('sessions.book') }}" class="inline-flex items-center justify-center px-5 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-blue-500/30">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
