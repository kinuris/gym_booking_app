                ...
                <div class="overflow-x-auto pb-2">
                    <div class="flex space-x-8 pb-4 min-w-max">
                        ...
                        <div class="bg-gray-800 bg-opacity-80 p-6 rounded-xl shadow-lg w-72 transform hover:scale-105 transition duration-300">
                            ...
                            <a href="/instructors/{{ $instructor->id }}" class="mt-6 block text-center bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg transition duration-300">View Profile</a>
                        </div>
                        @endforeach
                    </div>
                </div>
